...
As closed sets are straightly defined as the complements of open sets, the following properties can be induced from the open set axioms, sometimes referred as **closed set axioms**.
